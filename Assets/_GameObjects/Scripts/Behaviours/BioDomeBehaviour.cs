...
public class BioDomeBehaviour : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        else if (other.tag == "Enemy" && other.GetComponent<DummyEnemy>() != null)
        {
            enemiesInside += 1;
            other.GetComponent<DummyEnemy>().ToStop();
            other.GetComponent<DummyEnemy>().ChangeDomeStatus();
            other.GetComponent<DummyEnemy>().ReferenceDome(gameObject);
        }
    }
